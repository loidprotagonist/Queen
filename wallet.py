...
if __name__ == "__main__":
    ...
    while True:
        ...
        banner("WELCOME")
        print()
        p(C.W, "1. Create Wallet")
        p(C.W, "2. Open Wallet")
        p(C.W, "3. Send QUIN")
        p(C.W, "4. Receive QUIN")
        p(C.W, "5. Import Wallet")
        p(C.W, "6. Backup Wallet")
        p(C.W, "7. Exit")
        print()
        ...
        if choice == "1":
            ...
            banner("WARNING")
            print()
            p(C.W, "Your WALLET is protected by a PIN.")
            print()
            p(C.W, "Not Your PIN.")
            p(C.W, "Not Your COIN.")
            print()
            ...
            banner("WALLET")
            print()
            p(C.W, f"Wallet Name : {w.name}")
            p(C.W, f"Address     : {format_address(w.address)}")
            p(C.W, f"PIN         : ••••••")
            p(C.W, f"Balance     : 0.00000000 QUIN")
            ...
            if save == "y":
                ...
                p(C.W, f"Saving...")
                time.sleep(0.5)
                p(C.W, f"✅ Wallet Saved")
                p(C.W, f"Location : Wallet/{filename}")
                p(C.W, f"KEEP YOUR PIN SAFE")
            ...
            try:
                ...
                print()
                p(C.Y, f"Wallet    : {data['name']}")
                p(C.Y, f"Saved     : {destination}")
                p(C.Y, f"Timestamp : {int(time.time())}")
                print()
