...
if __name__ == "__main__":
    ...
    while True:
        ...
        banner("WELCOME")
        print()
        p(C.K, f"1. Create Wallet")
        p(C.K, f"2. Open Wallet")
        p(C.K, f"3. Send QUEEN")
        p(C.K, f"4. Receive QUEEN")
        p(C.K, f"5. Import Wallet")
        p(C.K, f"6. Backup Wallet")
        p(C.K, f"7. Exit")
        print()
        ...
        if choice == "1":
            ...
            print()
            print(f"🔑 PIN is hidden for security.")
            ...
            banner("WARNING")
            print()
            p(C.K, f"Your WALLET is protected by a PIN.")
            print()
            p(C.K, f"Not Your PIN.")
            p(C.K, f"Not Your COIN.")
            print()
            ...
            p(C.K, f"PIN         : ??????????")
            p(C.Y, f"Balance     : 0.00000000 QUEEN")
        ...
        #3
            ...
            os.system("python Loid_transaction.py")
